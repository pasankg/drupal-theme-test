 ...
 * @endcode
 */
$settings['hash_salt'] = 'ZAfkWlNV2bb6_PTVcYvyYzrkNoQVvB65LWDA0finuvqfK2d737mY7RsJDp6QAS_x1tRqVnBLqQ';
 ...
 */
#
if (file_exists(getcwd() . '/' . $site_path . '/settings.local.php')) {
  include getcwd() . '/' . $site_path . '/settings.local.php';
}
